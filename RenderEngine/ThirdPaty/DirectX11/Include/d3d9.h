...
DEFINE_GUID(IID_IDirect3D9Ex, 0x02177241, 0x69FC, 0x400C, 0x8F, 0xF1, 0x93,
            0xA4, 0x4D, 0xF6, 0x86, 0x1D);

/* IID_IDirect3DDevice9Ex */
// {B18B10CE-2649-405a-870F-95F777D4313A}
DEFINE_GUID(IID_IDirect3DDevice9Ex, 0xb18b10ce, 0x2649, 0x405a, 0x87, 0xf, 0x95,
            0xf7, 0x77, 0xd4, 0x31, 0x3a);

/* IID_IDirect3DSwapChain9Ex */
/* {91886CAF-1C3D-4d2e-A0AB-3E4C7D8D3303} */
DEFINE_GUID(IID_IDirect3DSwapChain9Ex, 0x91886caf, 0x1c3d, 0x4d2e, 0xa0, 0xab,
            0x3e, 0x4c, 0x7d, 0x8d, 0x33, 0x3);

/* IID_IDirect3D9ExOverlayExtension */
/* {187aeb13-aaf5-4c59-876d-e059088c0df8} */
DEFINE_GUID(IID_IDirect3D9ExOverlayExtension, 0x187aeb13, 0xaaf5, 0x4c59, 0x87,
            0x6d, 0xe0, 0x59, 0x8, 0x8c, 0xd, 0xf8);

/* IID_IDirect3DDevice9Video */
// {26DC4561-A1EE-4ae7-96DA-118A36C0EC95}
DEFINE_GUID(IID_IDirect3DDevice9Video, 0x26dc4561, 0xa1ee, 0x4ae7, 0x96, 0xda,
            0x11, 0x8a, 0x36, 0xc0, 0xec, 0x95);

/* IID_IDirect3D9AuthenticatedChannel */
// {FF24BEEE-DA21-4beb-98B5-D2F899F98AF9}
DEFINE_GUID(IID_IDirect3DAuthenticatedChannel9, 0xff24beee, 0xda21, 0x4beb,
            0x98, 0xb5, 0xd2, 0xf8, 0x99, 0xf9, 0x8a, 0xf9);

/* IID_IDirect3DCryptoSession9 */
// {FA0AB799-7A9C-48ca-8C5B-237E71A54434}
DEFINE_GUID(IID_IDirect3DCryptoSession9, 0xfa0ab799, 0x7a9c, 0x48ca, 0x8c, 0x5b,
            0x23, 0x7e, 0x71, 0xa5, 0x44, 0x34);
...
interface DECLSPEC_UUID("B18B10CE-2649-405a-870F-95F777D4313A")
    IDirect3DDevice9Ex;
interface DECLSPEC_UUID("91886CAF-1C3D-4d2e-A0AB-3E4C7D8D3303")
    IDirect3DSwapChain9Ex;
interface DECLSPEC_UUID("187AEB13-AAF5-4C59-876D-E059088C0DF8")
    IDirect3D9ExOverlayExtension;
interface DECLSPEC_UUID("26DC4561-A1EE-4ae7-96DA-118A36C0EC95")
    IDirect3DDevice9Video;
interface DECLSPEC_UUID("FF24BEEE-DA21-4beb-98B5-D2F899F98AF9")
    IDirect3DAuthenticatedChannel9;
interface DECLSPEC_UUID("FA0AB799-7A9C-48CA-8C5B-237E71A54434")
...
_COM_SMARTPTR_TYPEDEF(IDirect3D9ExOverlayExtension,
                      __uuidof(IDirect3D9ExOverlayExtension));
_COM_SMARTPTR_TYPEDEF(IDirect3DDevice9Video, __uuidof(IDirect3DDevice9Video));
_COM_SMARTPTR_TYPEDEF(IDirect3DAuthenticatedChannel9,
                      __uuidof(IDirect3DAuthenticatedChannel9));
_COM_SMARTPTR_TYPEDEF(IDirect3DCryptoSession9,
                      __uuidof(IDirect3DCryptoSession9));
 ...
 * but it needs to be defined here for compatibility with DX9 and earlier
 * versions. See the DirectX SDK for sample code on discovering driver
 * signatures.
 */
...
DECLARE_INTERFACE_(IDirect3D9Ex, IDirect3D9) {
  ...
  (THIS_ UINT Adapter, D3DDEVTYPE DeviceType, HWND hFocusWindow,
   DWORD BehaviorFlags, D3DPRESENT_PARAMETERS * pPresentationParameters,
   IDirect3DDevice9 * *ppReturnedDeviceInterface) PURE;
  STDMETHOD_(UINT, GetAdapterModeCountEx)
  (THIS_ UINT Adapter, CONST D3DDISPLAYMODEFILTER * pFilter) PURE;
  STDMETHOD(EnumAdapterModesEx)
  (THIS_ UINT Adapter, CONST D3DDISPLAYMODEFILTER * pFilter, UINT Mode,
   D3DDISPLAYMODEEX * pMode) PURE;
  STDMETHOD(GetAdapterDisplayModeEx)
  (THIS_ UINT Adapter, D3DDISPLAYMODEEX * pMode, D3DDISPLAYROTATION * pRotation)
      PURE;
...
#define IDirect3D9Ex_GetAdapterIdentifier(p, a, b, c)                          \
  (p)->lpVtbl->GetAdapterIdentifier(p, a, b, c)
#define IDirect3D9Ex_GetAdapterModeCount(p, a, b)                              \
  (p)->lpVtbl->GetAdapterModeCount(p, a, b)
#define IDirect3D9Ex_EnumAdapterModes(p, a, b, c, d)                           \
  (p)->lpVtbl->EnumAdapterModes(p, a, b, c, d)
#define IDirect3D9Ex_GetAdapterDisplayMode(p, a, b)                            \
  (p)->lpVtbl->GetAdapterDisplayMode(p, a, b)
#define IDirect3D9Ex_CheckDeviceType(p, a, b, c, d, e)                         \
  (p)->lpVtbl->CheckDeviceType(p, a, b, c, d, e)
#define IDirect3D9Ex_CheckDeviceFormat(p, a, b, c, d, e, f)                    \
  (p)->lpVtbl->CheckDeviceFormat(p, a, b, c, d, e, f)
#define IDirect3D9Ex_CheckDeviceMultiSampleType(p, a, b, c, d, e, f)           \
  (p)->lpVtbl->CheckDeviceMultiSampleType(p, a, b, c, d, e, f)
#define IDirect3D9Ex_CheckDepthStencilMatch(p, a, b, c, d, e)                  \
  (p)->lpVtbl->CheckDepthStencilMatch(p, a, b, c, d, e)
#define IDirect3D9Ex_CheckDeviceFormatConversion(p, a, b, c, d)                \
  (p)->lpVtbl->CheckDeviceFormatConversion(p, a, b, c, d)
#define IDirect3D9Ex_GetDeviceCaps(p, a, b, c)                                 \
  (p)->lpVtbl->GetDeviceCaps(p, a, b, c)
#define IDirect3D9Ex_GetAdapterMonitor(p, a)                                   \
  (p)->lpVtbl->GetAdapterMonitor(p, a)
#define IDirect3D9Ex_CreateDevice(p, a, b, c, d, e, f)                         \
  (p)->lpVtbl->CreateDevice(p, a, b, c, d, e, f)
#define IDirect3D9Ex_GetAdapterModeCountEx(p, a, b)                            \
  (p)->lpVtbl->GetAdapterModeCountEx(p, a, b)
#define IDirect3D9Ex_EnumAdapterModesEx(p, a, b, c, d)                         \
  (p)->lpVtbl->EnumAdapterModesEx(p, a, b, c, d)
#define IDirect3D9Ex_GetAdapterDisplayModeEx(p, a, b, c)                       \
  (p)->lpVtbl->GetAdapterDisplayModeEx(p, a, b, c)
#define IDirect3D9Ex_CreateDeviceEx(p, a, b, c, d, e, f, g)                    \
  (p)->lpVtbl->CreateDeviceEx(p, a, b, c, d, e, f, g)
#define IDirect3D9Ex_GetAdapterLUID(p, a, b)                                   \
...
#define IDirect3D9Ex_CreateDevice(p, a, b, c, d, e, f)                         \
  (p)->CreateDevice(a, b, c, d, e, f)
#define IDirect3D9Ex_GetAdapterModeCountEx(p, a, b)                            \
  (p)->GetAdapterModeCountEx(a, b)
#define IDirect3D9Ex_EnumAdapterModesEx(p, a, b, c, d)                         \
  (p)->EnumAdapterModesEx(a, b, c, d)
#define IDirect3D9Ex_GetAdapterDisplayModeEx(p, a, b, c)                       \
  (p)->GetAdapterDisplayModeEx(a, b, c)
#define IDirect3D9Ex_CreateDeviceEx(p, a, b, c, d, e, f, g)                    \
  (p)->CreateDeviceEx(a, b, c, d, e, f, g)
...
DECLARE_INTERFACE_(IDirect3DDevice9Ex, IDirect3DDevice9) {
  ...
  (THIS_ UINT width, UINT height, float *rows, float *columns) PURE;
  STDMETHOD(ComposeRects)
  (THIS_ IDirect3DSurface9 * pSrc, IDirect3DSurface9 * pDst,
   IDirect3DVertexBuffer9 * pSrcRectDescs, UINT NumRects,
   IDirect3DVertexBuffer9 * pDstRectDescs, D3DCOMPOSERECTSOP Operation,
   int Xoffset, int Yoffset) PURE;
  STDMETHOD(PresentEx)
  (THIS_ CONST RECT * pSourceRect, CONST RECT * pDestRect,
   HWND hDestWindowOverride, CONST RGNDATA * pDirtyRegion, DWORD dwFlags) PURE;
  ...
  (THIS_ IDirect3DResource9 * *pResourceArray, UINT32 NumResources) PURE;
  ...
  STDMETHOD(ResetEx)
  (THIS_ D3DPRESENT_PARAMETERS * pPresentationParameters,
   D3DDISPLAYMODEEX * pFullscreenDisplayMode) PURE;
  STDMETHOD(GetDisplayModeEx)
  (THIS_ UINT iSwapChain, D3DDISPLAYMODEEX * pMode,
   D3DDISPLAYROTATION * pRotation) PURE;
};

typedef struct IDirect3DDevice9Ex *LPDIRECT3DDEVICE9EX, *PDIRECT3DDEVICE9EX;

#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DDevice9Ex_QueryInterface(p, a, b)                             \
  (p)->lpVtbl->QueryInterface(p, a, b)
#define IDirect3DDevice9Ex_AddRef(p) (p)->lpVtbl->AddRef(p)
#define IDirect3DDevice9Ex_Release(p) (p)->lpVtbl->Release(p)
#define IDirect3DDevice9Ex_TestCooperativeLevel(p)                             \
  (p)->lpVtbl->TestCooperativeLevel(p)
#define IDirect3DDevice9Ex_GetAvailableTextureMem(p)                           \
  (p)->lpVtbl->GetAvailableTextureMem(p)
#define IDirect3DDevice9Ex_EvictManagedResources(p)                            \
  (p)->lpVtbl->EvictManagedResources(p)
...
#define IDirect3DDevice9Ex_GetDisplayMode(p, a, b)                             \
  (p)->lpVtbl->GetDisplayMode(p, a, b)
#define IDirect3DDevice9Ex_GetCreationParameters(p, a)                         \
  (p)->lpVtbl->GetCreationParameters(p, a)
#define IDirect3DDevice9Ex_SetCursorProperties(p, a, b, c)                     \
  (p)->lpVtbl->SetCursorProperties(p, a, b, c)
#define IDirect3DDevice9Ex_SetCursorPosition(p, a, b, c)                       \
  (p)->lpVtbl->SetCursorPosition(p, a, b, c)
#define IDirect3DDevice9Ex_ShowCursor(p, a) (p)->lpVtbl->ShowCursor(p, a)
#define IDirect3DDevice9Ex_CreateAdditionalSwapChain(p, a, b)                  \
  (p)->lpVtbl->CreateAdditionalSwapChain(p, a, b)
#define IDirect3DDevice9Ex_GetSwapChain(p, a, b)                               \
  (p)->lpVtbl->GetSwapChain(p, a, b)
#define IDirect3DDevice9Ex_GetNumberOfSwapChains(p)                            \
  (p)->lpVtbl->GetNumberOfSwapChains(p)
#define IDirect3DDevice9Ex_Reset(p, a) (p)->lpVtbl->Reset(p, a)
#define IDirect3DDevice9Ex_Present(p, a, b, c, d)                              \
  (p)->lpVtbl->Present(p, a, b, c, d)
#define IDirect3DDevice9Ex_GetBackBuffer(p, a, b, c, d)                        \
  (p)->lpVtbl->GetBackBuffer(p, a, b, c, d)
#define IDirect3DDevice9Ex_GetRasterStatus(p, a, b)                            \
  (p)->lpVtbl->GetRasterStatus(p, a, b)
#define IDirect3DDevice9Ex_SetDialogBoxMode(p, a)                              \
  (p)->lpVtbl->SetDialogBoxMode(p, a)
#define IDirect3DDevice9Ex_SetGammaRamp(p, a, b, c)                            \
  (p)->lpVtbl->SetGammaRamp(p, a, b, c)
#define IDirect3DDevice9Ex_GetGammaRamp(p, a, b)                               \
  (p)->lpVtbl->GetGammaRamp(p, a, b)
...
#define IDirect3DDevice9Ex_CreateCubeTexture(p, a, b, c, d, e, f, g)           \
  (p)->lpVtbl->CreateCubeTexture(p, a, b, c, d, e, f, g)
#define IDirect3DDevice9Ex_CreateVertexBuffer(p, a, b, c, d, e, f)             \
  (p)->lpVtbl->CreateVertexBuffer(p, a, b, c, d, e, f)
#define IDirect3DDevice9Ex_CreateIndexBuffer(p, a, b, c, d, e, f)              \
  (p)->lpVtbl->CreateIndexBuffer(p, a, b, c, d, e, f)
#define IDirect3DDevice9Ex_CreateRenderTarget(p, a, b, c, d, e, f, g, h)       \
  (p)->lpVtbl->CreateRenderTarget(p, a, b, c, d, e, f, g, h)
#define IDirect3DDevice9Ex_CreateDepthStencilSurface(p, a, b, c, d, e, f, g,   \
                                                     h)                        \
  (p)->lpVtbl->CreateDepthStencilSurface(p, a, b, c, d, e, f, g, h)
#define IDirect3DDevice9Ex_UpdateSurface(p, a, b, c, d)                        \
  (p)->lpVtbl->UpdateSurface(p, a, b, c, d)
#define IDirect3DDevice9Ex_UpdateTexture(p, a, b)                              \
  (p)->lpVtbl->UpdateTexture(p, a, b)
#define IDirect3DDevice9Ex_GetRenderTargetData(p, a, b)                        \
  (p)->lpVtbl->GetRenderTargetData(p, a, b)
#define IDirect3DDevice9Ex_GetFrontBufferData(p, a, b)                         \
  (p)->lpVtbl->GetFrontBufferData(p, a, b)
#define IDirect3DDevice9Ex_StretchRect(p, a, b, c, d, e)                       \
  (p)->lpVtbl->StretchRect(p, a, b, c, d, e)
#define IDirect3DDevice9Ex_ColorFill(p, a, b, c)                               \
  (p)->lpVtbl->ColorFill(p, a, b, c)
#define IDirect3DDevice9Ex_CreateOffscreenPlainSurface(p, a, b, c, d, e, f)    \
  (p)->lpVtbl->CreateOffscreenPlainSurface(p, a, b, c, d, e, f)
#define IDirect3DDevice9Ex_SetRenderTarget(p, a, b)                            \
  (p)->lpVtbl->SetRenderTarget(p, a, b)
#define IDirect3DDevice9Ex_GetRenderTarget(p, a, b)                            \
  (p)->lpVtbl->GetRenderTarget(p, a, b)
#define IDirect3DDevice9Ex_SetDepthStencilSurface(p, a)                        \
  (p)->lpVtbl->SetDepthStencilSurface(p, a)
#define IDirect3DDevice9Ex_GetDepthStencilSurface(p, a)                        \
  (p)->lpVtbl->GetDepthStencilSurface(p, a)
#define IDirect3DDevice9Ex_BeginScene(p) (p)->lpVtbl->BeginScene(p)
#define IDirect3DDevice9Ex_EndScene(p) (p)->lpVtbl->EndScene(p)
#define IDirect3DDevice9Ex_Clear(p, a, b, c, d, e, f)                          \
  (p)->lpVtbl->Clear(p, a, b, c, d, e, f)
#define IDirect3DDevice9Ex_SetTransform(p, a, b)                               \
  (p)->lpVtbl->SetTransform(p, a, b)
#define IDirect3DDevice9Ex_GetTransform(p, a, b)                               \
  (p)->lpVtbl->GetTransform(p, a, b)
#define IDirect3DDevice9Ex_MultiplyTransform(p, a, b)                          \
  (p)->lpVtbl->MultiplyTransform(p, a, b)
...
#define IDirect3DDevice9Ex_LightEnable(p, a, b)                                \
  (p)->lpVtbl->LightEnable(p, a, b)
#define IDirect3DDevice9Ex_GetLightEnable(p, a, b)                             \
  (p)->lpVtbl->GetLightEnable(p, a, b)
#define IDirect3DDevice9Ex_SetClipPlane(p, a, b)                               \
  (p)->lpVtbl->SetClipPlane(p, a, b)
#define IDirect3DDevice9Ex_GetClipPlane(p, a, b)                               \
  (p)->lpVtbl->GetClipPlane(p, a, b)
#define IDirect3DDevice9Ex_SetRenderState(p, a, b)                             \
  (p)->lpVtbl->SetRenderState(p, a, b)
#define IDirect3DDevice9Ex_GetRenderState(p, a, b)                             \
  (p)->lpVtbl->GetRenderState(p, a, b)
#define IDirect3DDevice9Ex_CreateStateBlock(p, a, b)                           \
  (p)->lpVtbl->CreateStateBlock(p, a, b)
...
#define IDirect3DDevice9Ex_GetTextureStageState(p, a, b, c)                    \
  (p)->lpVtbl->GetTextureStageState(p, a, b, c)
#define IDirect3DDevice9Ex_SetTextureStageState(p, a, b, c)                    \
  (p)->lpVtbl->SetTextureStageState(p, a, b, c)
#define IDirect3DDevice9Ex_GetSamplerState(p, a, b, c)                         \
  (p)->lpVtbl->GetSamplerState(p, a, b, c)
#define IDirect3DDevice9Ex_SetSamplerState(p, a, b, c)                         \
  (p)->lpVtbl->SetSamplerState(p, a, b, c)
#define IDirect3DDevice9Ex_ValidateDevice(p, a)                                \
  (p)->lpVtbl->ValidateDevice(p, a)
#define IDirect3DDevice9Ex_SetPaletteEntries(p, a, b)                          \
  (p)->lpVtbl->SetPaletteEntries(p, a, b)
#define IDirect3DDevice9Ex_GetPaletteEntries(p, a, b)                          \
  (p)->lpVtbl->GetPaletteEntries(p, a, b)
#define IDirect3DDevice9Ex_SetCurrentTexturePalette(p, a)                      \
  (p)->lpVtbl->SetCurrentTexturePalette(p, a)
#define IDirect3DDevice9Ex_GetCurrentTexturePalette(p, a)                      \
  (p)->lpVtbl->GetCurrentTexturePalette(p, a)
#define IDirect3DDevice9Ex_SetScissorRect(p, a)                                \
  (p)->lpVtbl->SetScissorRect(p, a)
#define IDirect3DDevice9Ex_GetScissorRect(p, a)                                \
  (p)->lpVtbl->GetScissorRect(p, a)
#define IDirect3DDevice9Ex_SetSoftwareVertexProcessing(p, a)                   \
  (p)->lpVtbl->SetSoftwareVertexProcessing(p, a)
#define IDirect3DDevice9Ex_GetSoftwareVertexProcessing(p)                      \
  (p)->lpVtbl->GetSoftwareVertexProcessing(p)
...
#define IDirect3DDevice9Ex_DrawPrimitive(p, a, b, c)                           \
  (p)->lpVtbl->DrawPrimitive(p, a, b, c)
#define IDirect3DDevice9Ex_DrawIndexedPrimitive(p, a, b, c, d, e, f)           \
  (p)->lpVtbl->DrawIndexedPrimitive(p, a, b, c, d, e, f)
#define IDirect3DDevice9Ex_DrawPrimitiveUP(p, a, b, c, d)                      \
  (p)->lpVtbl->DrawPrimitiveUP(p, a, b, c, d)
#define IDirect3DDevice9Ex_DrawIndexedPrimitiveUP(p, a, b, c, d, e, f, g, h)   \
  (p)->lpVtbl->DrawIndexedPrimitiveUP(p, a, b, c, d, e, f, g, h)
#define IDirect3DDevice9Ex_ProcessVertices(p, a, b, c, d, e, f)                \
  (p)->lpVtbl->ProcessVertices(p, a, b, c, d, e, f)
#define IDirect3DDevice9Ex_CreateVertexDeclaration(p, a, b)                    \
  (p)->lpVtbl->CreateVertexDeclaration(p, a, b)
#define IDirect3DDevice9Ex_SetVertexDeclaration(p, a)                          \
  (p)->lpVtbl->SetVertexDeclaration(p, a)
#define IDirect3DDevice9Ex_GetVertexDeclaration(p, a)                          \
  (p)->lpVtbl->GetVertexDeclaration(p, a)
#define IDirect3DDevice9Ex_SetFVF(p, a) (p)->lpVtbl->SetFVF(p, a)
#define IDirect3DDevice9Ex_GetFVF(p, a) (p)->lpVtbl->GetFVF(p, a)
#define IDirect3DDevice9Ex_CreateVertexShader(p, a, b)                         \
  (p)->lpVtbl->CreateVertexShader(p, a, b)
#define IDirect3DDevice9Ex_SetVertexShader(p, a)                               \
  (p)->lpVtbl->SetVertexShader(p, a)
#define IDirect3DDevice9Ex_GetVertexShader(p, a)                               \
  (p)->lpVtbl->GetVertexShader(p, a)
#define IDirect3DDevice9Ex_SetVertexShaderConstantF(p, a, b, c)                \
  (p)->lpVtbl->SetVertexShaderConstantF(p, a, b, c)
#define IDirect3DDevice9Ex_GetVertexShaderConstantF(p, a, b, c)                \
  (p)->lpVtbl->GetVertexShaderConstantF(p, a, b, c)
#define IDirect3DDevice9Ex_SetVertexShaderConstantI(p, a, b, c)                \
  (p)->lpVtbl->SetVertexShaderConstantI(p, a, b, c)
#define IDirect3DDevice9Ex_GetVertexShaderConstantI(p, a, b, c)                \
  (p)->lpVtbl->GetVertexShaderConstantI(p, a, b, c)
#define IDirect3DDevice9Ex_SetVertexShaderConstantB(p, a, b, c)                \
  (p)->lpVtbl->SetVertexShaderConstantB(p, a, b, c)
#define IDirect3DDevice9Ex_GetVertexShaderConstantB(p, a, b, c)                \
  (p)->lpVtbl->GetVertexShaderConstantB(p, a, b, c)
#define IDirect3DDevice9Ex_SetStreamSource(p, a, b, c, d)                      \
  (p)->lpVtbl->SetStreamSource(p, a, b, c, d)
#define IDirect3DDevice9Ex_GetStreamSource(p, a, b, c, d)                      \
  (p)->lpVtbl->GetStreamSource(p, a, b, c, d)
#define IDirect3DDevice9Ex_SetStreamSourceFreq(p, a, b)                        \
  (p)->lpVtbl->SetStreamSourceFreq(p, a, b)
#define IDirect3DDevice9Ex_GetStreamSourceFreq(p, a, b)                        \
  (p)->lpVtbl->GetStreamSourceFreq(p, a, b)
...
#define IDirect3DDevice9Ex_CreatePixelShader(p, a, b)                          \
  (p)->lpVtbl->CreatePixelShader(p, a, b)
#define IDirect3DDevice9Ex_SetPixelShader(p, a)                                \
  (p)->lpVtbl->SetPixelShader(p, a)
#define IDirect3DDevice9Ex_GetPixelShader(p, a)                                \
  (p)->lpVtbl->GetPixelShader(p, a)
#define IDirect3DDevice9Ex_SetPixelShaderConstantF(p, a, b, c)                 \
  (p)->lpVtbl->SetPixelShaderConstantF(p, a, b, c)
#define IDirect3DDevice9Ex_GetPixelShaderConstantF(p, a, b, c)                 \
  (p)->lpVtbl->GetPixelShaderConstantF(p, a, b, c)
#define IDirect3DDevice9Ex_SetPixelShaderConstantI(p, a, b, c)                 \
  (p)->lpVtbl->SetPixelShaderConstantI(p, a, b, c)
#define IDirect3DDevice9Ex_GetPixelShaderConstantI(p, a, b, c)                 \
  (p)->lpVtbl->GetPixelShaderConstantI(p, a, b, c)
#define IDirect3DDevice9Ex_SetPixelShaderConstantB(p, a, b, c)                 \
  (p)->lpVtbl->SetPixelShaderConstantB(p, a, b, c)
#define IDirect3DDevice9Ex_GetPixelShaderConstantB(p, a, b, c)                 \
  (p)->lpVtbl->GetPixelShaderConstantB(p, a, b, c)
#define IDirect3DDevice9Ex_DrawRectPatch(p, a, b, c)                           \
  (p)->lpVtbl->DrawRectPatch(p, a, b, c)
#define IDirect3DDevice9Ex_DrawTriPatch(p, a, b, c)                            \
  (p)->lpVtbl->DrawTriPatch(p, a, b, c)
#define IDirect3DDevice9Ex_DeletePatch(p, a) (p)->lpVtbl->DeletePatch(p, a)
#define IDirect3DDevice9Ex_CreateQuery(p, a, b)                                \
  (p)->lpVtbl->CreateQuery(p, a, b)
#define IDirect3DDevice9Ex_SetConvolutionMonoKernel(p, a, b, c, d)             \
  (p)->lpVtbl->SetConvolutionMonoKernel(p, a, b, c, d)
#define IDirect3DDevice9Ex_ComposeRects(p, a, b, c, d, e, f, g, h)             \
  (p)->lpVtbl->ComposeRects(p, a, b, c, d, e, f, g, h)
#define IDirect3DDevice9Ex_PresentEx(p, a, b, c, d, e)                         \
  (p)->lpVtbl->PresentEx(p, a, b, c, d, e)
#define IDirect3DDevice9Ex_GetGPUThreadPriority(p, a)                          \
  (p)->lpVtbl->GetGPUThreadPriority(p, a)
#define IDirect3DDevice9Ex_SetGPUThreadPriority(p, a)                          \
  (p)->lpVtbl->SetGPUThreadPriority(p, a)
#define IDirect3DDevice9Ex_WaitForVBlank(p, a) (p)->lpVtbl->WaitForVBlank(p, a)
#define IDirect3DDevice9Ex_CheckResourceResidency(p, a, b)                     \
  (p)->lpVtbl->CheckResourceResidency(p, a, b)
#define IDirect3DDevice9Ex_SetMaximumFrameLatency(p, a)                        \
  (p)->lpVtbl->SetMaximumFrameLatency(p, a)
#define IDirect3DDevice9Ex_GetMaximumFrameLatency(p, a)                        \
  (p)->lpVtbl->GetMaximumFrameLatency(p, a)
#define IDirect3DDevice9Ex_CheckDeviceState(p, a)                              \
...
#define IDirect3DDevice9Ex_CreateOffscreenPlainSurfaceEx(p, a, b, c, d, e, f,  \
                                                         g)                    \
  (p)->lpVtbl->CreateOffscreenPlainSurfaceEx(p, a, b, c, d, e, f, g)
#define IDirect3DDevice9Ex_CreateDepthStencilSurfaceEx(p, a, b, c, d, e, f, g, \
                                                       h, i)                   \
  (p)->lpVtbl->CreateDepthStencilSurfaceEx(p, a, b, c, d, e, f, g, h, i)
#define IDirect3DDevice9Ex_ResetEx(p, a, b) (p)->lpVtbl->ResetEx(p, a, b)
#define IDirect3DDevice9Ex_GetDisplayModeEx(p, a, b, c)                        \
...
#define IDirect3DDevice9Ex_SetPaletteEntries(p, a, b)                          \
  (p)->SetPaletteEntries(a, b)
#define IDirect3DDevice9Ex_GetPaletteEntries(p, a, b)                          \
  (p)->GetPaletteEntries(a, b)
#define IDirect3DDevice9Ex_SetCurrentTexturePalette(p, a)                      \
  (p)->SetCurrentTexturePalette(a)
#define IDirect3DDevice9Ex_GetCurrentTexturePalette(p, a)                      \
  (p)->GetCurrentTexturePalette(a)
...
#define IDirect3DDevice9Ex_CreateVertexDeclaration(p, a, b)                    \
  (p)->CreateVertexDeclaration(a, b)
#define IDirect3DDevice9Ex_SetVertexDeclaration(p, a)                          \
  (p)->SetVertexDeclaration(a)
#define IDirect3DDevice9Ex_GetVertexDeclaration(p, a)                          \
  (p)->GetVertexDeclaration(a)
...
#define IDirect3DDevice9Ex_ComposeRects(p, a, b, c, d, e, f, g, h)             \
  (p)->ComposeRects(a, b, c, d, e, f, g, h)
#define IDirect3DDevice9Ex_PresentEx(p, a, b, c, d, e)                         \
  (p)->PresentEx(a, b, c, d, e)
#define IDirect3DDevice9Ex_GetGPUThreadPriority(p, a)                          \
  (p)->GetGPUThreadPriority(a)
#define IDirect3DDevice9Ex_SetGPUThreadPriority(p, a)                          \
  (p)->SetGPUThreadPriority(a)
#define IDirect3DDevice9Ex_WaitForVBlank(p, a) (p)->WaitForVBlank(a)
#define IDirect3DDevice9Ex_CheckResourceResidency(p, a, b)                     \
  (p)->CheckResourceResidency(a, b)
#define IDirect3DDevice9Ex_SetMaximumFrameLatency(p, a)                        \
  (p)->SetMaximumFrameLatency(a)
#define IDirect3DDevice9Ex_GetMaximumFrameLatency(p, a)                        \
  (p)->GetMaximumFrameLatency(a)
...
DECLARE_INTERFACE_(IDirect3DSwapChain9Ex, IDirect3DSwapChain9) {
  ...
  (THIS_ D3DPRESENTSTATS * pPresentationStatistics) PURE;
  STDMETHOD(GetDisplayModeEx)
  (THIS_ D3DDISPLAYMODEEX * pMode, D3DDISPLAYROTATION * pRotation) PURE;
};
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DSwapChain9Ex_QueryInterface(p, a, b)                          \
  (p)->lpVtbl->QueryInterface(p, a, b)
#define IDirect3DSwapChain9Ex_AddRef(p) (p)->lpVtbl->AddRef(p)
#define IDirect3DSwapChain9Ex_Release(p) (p)->lpVtbl->Release(p)
#define IDirect3DSwapChain9Ex_Present(p, a, b, c, d, e)                        \
  (p)->lpVtbl->Present(p, a, b, c, d, e)
#define IDirect3DSwapChain9Ex_GetFrontBufferData(p, a)                         \
  (p)->lpVtbl->GetFrontBufferData(p, a)
#define IDirect3DSwapChain9Ex_GetBackBuffer(p, a, b, c)                        \
  (p)->lpVtbl->GetBackBuffer(p, a, b, c)
#define IDirect3DSwapChain9Ex_GetRasterStatus(p, a)                            \
  (p)->lpVtbl->GetRasterStatus(p, a)
#define IDirect3DSwapChain9Ex_GetDisplayMode(p, a)                             \
  (p)->lpVtbl->GetDisplayMode(p, a)
#define IDirect3DSwapChain9Ex_GetDevice(p, a) (p)->lpVtbl->GetDevice(p, a)
#define IDirect3DSwapChain9Ex_GetPresentParameters(p, a)                       \
  (p)->lpVtbl->GetPresentParameters(p, a)
#define IDirect3DSwapChain9Ex_GetLastPresentCount(p, a)                        \
  (p)->lpVtbl->GetLastPresentCount(p, a)
#define IDirect3DSwapChain9Ex_GetPresentStats(p, a)                            \
  (p)->lpVtbl->GetPresentStats(p, a)
#define IDirect3DSwapChain9Ex_GetDisplayModeEx(p, a, b)                        \
...
DECLARE_INTERFACE_(IDirect3D9ExOverlayExtension, IUnknown) {
  ...
  (THIS_ UINT Adapter, D3DDEVTYPE DevType, UINT OverlayWidth,
...
typedef struct IDirect3D9ExOverlayExtension *LPDIRECT3D9EXOVERLAYEXTENSION,
    *PDIRECT3D9EXOVERLAYEXTENSION;

#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3D9ExOverlayExtension_QueryInterface(p, a, b)                   \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirect3D9ExOverlayExtension_CheckDeviceOverlayType(p, a, b, c, d, e,  \
                                                            f, g, h)           \
...
#define IDirect3D9ExOverlayExtension_CheckDeviceOverlayType(p, a, b, c, d, e,  \
                                                            f, g, h)           \
  (p)->CheckDeviceOverlayType(a, b, c, d, e, f, g, h)
#endif
...
DECLARE_INTERFACE_(IDirect3DDevice9Video, IUnknown) {
  ...
  STDMETHOD(GetContentProtectionCaps)
  (THIS_ CONST GUID * pCryptoType, CONST GUID * pDecodeProfile,
   D3DCONTENTPROTECTIONCAPS * pCaps) PURE;
  STDMETHOD(CreateAuthenticatedChannel)
  (THIS_ D3DAUTHENTICATEDCHANNELTYPE ChannelType,
   IDirect3DAuthenticatedChannel9 * *ppAuthenticatedChannel,
   HANDLE * pChannelHandle) PURE;
  STDMETHOD(CreateCryptoSession)
  (THIS_ CONST GUID * pCryptoType, CONST GUID * pDecodeProfile,
   IDirect3DCryptoSession9 * *ppCryptoSession, HANDLE * pCryptoHandle) PURE;
};

typedef struct IDirect3DDevice9Video *LPDIRECT3DDEVICE9VIDEO,
    *PDIRECT3DDEVICE9VIDEO;

#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DDevice9Video_QueryInterface(p, a, b)                          \
  (p)->lpVtbl->QueryInterface(p, a, b)
#define IDirect3DDevice9Video_AddRef(p) (p)->lpVtbl->AddRef(p)
#define IDirect3DDevice9Video_Release(p) (p)->lpVtbl->Release(p)
#define IDirect3DDevice9Video_GetContentProtectionCaps(p, a, b, c)             \
  (p)->lpVtbl->GetContentProtectionCaps(p, a, b, c)
#define IDirect3DDevice9Video_CreateAuthenticatedChannel(p, a, b, c)           \
  (p)->lpVtbl->CreateAuthenticatedChannel(p, a, b, c)
#define IDirect3DDevice9Video_CreateCryptoSession(p, a, b, c, d)               \
...
#define IDirect3DDevice9Video_GetContentProtectionCaps(p, a, b, c)             \
  (p)->GetContentProtectionCaps(a, b, c)
#define IDirect3DDevice9Video_CreateAuthenticatedChannel(p, a, b, c)           \
  (p)->CreateAuthenticatedChannel(a, b, c)
#define IDirect3DDevice9Video_CreateCryptoSession(p, a, b, c, d)               \
...
DECLARE_INTERFACE_(IDirect3DAuthenticatedChannel9, IUnknown) {
  ...
  (THIS_ UINT CertifacteSize, BYTE * ppCertificate) PURE;
  STDMETHOD(NegotiateKeyExchange)(THIS_ UINT DataSize, VOID * pData) PURE;
  STDMETHOD(Query)
  (THIS_ UINT InputSize, CONST VOID * pInput, UINT OutputSize, VOID * pOutput)
      PURE;
  STDMETHOD(Configure)
  (THIS_ UINT InputSize, CONST VOID * pInput,
   D3DAUTHENTICATEDCHANNEL_CONFIGURE_OUTPUT * pOutput) PURE;
};

typedef struct IDirect3DAuthenticatedChannel9 *LPDIRECT3DAUTHENTICATEDCHANNEL9,
    *PDIRECT3DAUTHENTICATEDCHANNEL9;

#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DAuthenticatedChannel9_QueryInterface(p, a, b)                 \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirect3DAuthenticatedChannel9_GetCertificateSize(p, a)                \
  (p)->lpVtbl->GetCertificateSize(p, a)
#define IDirect3DAuthenticatedChannel9_GetCertificate(p, a, b)                 \
  (p)->lpVtbl->GetCertificate(p, a, b)
#define IDirect3DAuthenticatedChannel9_NegotiateKeyExchange(p, a, b)           \
  (p)->lpVtbl->NegotiateKeyExchange(p, a, b)
#define IDirect3DAuthenticatedChannel9_Query(p, a, b, c, d)                    \
  (p)->lpVtbl->Query(p, a, b, c, d)
#define IDirect3DAuthenticatedChannel9_Configure(p, a, b, c)                   \
  (p)->lpVtbl->Configure(p, a, b, c)
#else
#define IDirect3DAuthenticatedChannel9_QueryInterface(p, a, b)                 \
  (p)->QueryInterface(a, b)
...
#define IDirect3DAuthenticatedChannel9_GetCertificateSize(p, a)                \
  (p)->GetCertificateSize(a)
#define IDirect3DAuthenticatedChannel9_GetCertificate(p, a, b)                 \
  (p)->GetCertificate(a, b)
#define IDirect3DAuthenticatedChannel9_NegotiateKeyExchange(p, a, b)           \
  (p)->NegotiateKeyExchange(a, b)
#define IDirect3DAuthenticatedChannel9_Query(p, a, b, c, d)                    \
  (p)->Query(a, b, c, d)
#define IDirect3DAuthenticatedChannel9_Configure(p, a, b, c)                   \
  (p)->Configure(a, b, c)
...
DECLARE_INTERFACE_(IDirect3DCryptoSession9, IUnknown) {
  ...
  (THIS_ UINT CertifacteSize, BYTE * ppCertificate) PURE;
  STDMETHOD(NegotiateKeyExchange)(THIS_ UINT DataSize, VOID * pData) PURE;
  STDMETHOD(EncryptionBlt)
  (THIS_ IDirect3DSurface9 * pSrcSurface, IDirect3DSurface9 * pDstSurface,
   UINT DstSurfaceSize, VOID * pIV) PURE;
  STDMETHOD(DecryptionBlt)
  (THIS_ IDirect3DSurface9 * pSrcSurface, IDirect3DSurface9 * pDstSurface,
   UINT SrcSurfaceSize, D3DENCRYPTED_BLOCK_INFO * pEncryptedBlockInfo,
   VOID * pContentKey, VOID * pIV) PURE;
  STDMETHOD(GetSurfacePitch)
  (THIS_ IDirect3DSurface9 * pSrcSurface, UINT * pSurfacePitch) PURE;
  STDMETHOD(StartSessionKeyRefresh)
  (THIS_ VOID * pRandomNumber, UINT RandomNumberSize) PURE;
  STDMETHOD(FinishSessionKeyRefresh)(THIS) PURE;
  STDMETHOD(GetEncryptionBltKey)(THIS_ VOID * pReadbackKey, UINT KeySize) PURE;
};

typedef struct IDirect3DCryptoSession9 *LPDIRECT3DCRYPTOSESSION9,
    *PDIRECT3DCRYPTOSESSION9;

#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DCryptoSession9_QueryInterface(p, a, b)                        \
  (p)->lpVtbl->QueryInterface(p, a, b)
#define IDirect3DCryptoSession9_AddRef(p) (p)->lpVtbl->AddRef(p)
#define IDirect3DCryptoSession9_Release(p) (p)->lpVtbl->Release(p)
#define IDirect3DCryptoSession9_GetCertificateSize(p, a)                       \
  (p)->lpVtbl->GetCertificateSize(p, a)
#define IDirect3DCryptoSession9_GetCertificate(p, a, b)                        \
  (p)->lpVtbl->GetCertificate(p, a, b)
#define IDirect3DCryptoSession9_NegotiateKeyExchange(p, a, b)                  \
  (p)->lpVtbl->NegotiateKeyExchange(p, a, b)
#define IDirect3DCryptoSession9_EncryptionBlt(p, a, b, c, d)                   \
  (p)->lpVtbl->EncryptionBlt(p, a, b, c, d)
#define IDirect3DCryptoSession9_DecryptionBlt(p, a, b, c, d, e, f)             \
  (p)->lpVtbl->DecryptionBlt(p, a, b, c, d, e, f)
#define IDirect3DCryptoSession9_GetSurfacePitch(p, a, b)                       \
  (p)->lpVtbl->GetSurfacePitch(p, a, b)
#define IDirect3DCryptoSession9_StartSessionKeyRefresh(p, a, b)                \
  (p)->lpVtbl->StartSessionKeyRefresh(p, a, b)
#define IDirect3DCryptoSession9_FinishSessionKeyRefresh(p)                     \
  (p)->lpVtbl->FinishSessionKeyRefresh(p)
#define IDirect3DCryptoSession9_GetEncryptionBltKey(p, a, b)                   \
  (p)->lpVtbl->GetEncryptionBltKey(p, a, b)
#else
#define IDirect3DCryptoSession9_QueryInterface(p, a, b)                        \
  (p)->QueryInterface(a, b)
...
#define IDirect3DCryptoSession9_DecryptionBlt(p, a, b, c, d, e, f)             \
  (p)->DecryptionBlt(a, b, c, d, e, f)
#define IDirect3DCryptoSession9_GetSurfacePitch(p, a, b)                       \
  (p)->GetSurfacePitch(a, b)
#define IDirect3DCryptoSession9_StartSessionKeyRefresh(p, a, b)                \
  (p)->StartSessionKeyRefresh(a, b)
#define IDirect3DCryptoSession9_FinishSessionKeyRefresh(p)                     \
  (p)->FinishSessionKeyRefresh()
#define IDirect3DCryptoSession9_GetEncryptionBltKey(p, a, b)                   \
  (p)->GetEncryptionBltKey(a, b)
#endif
