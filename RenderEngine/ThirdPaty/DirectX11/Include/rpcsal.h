...
#define __RPC__deref_in_opt_string                                             \
  __RPC__deref_in_opt __pre __deref __nullterminated
#define __RPC__deref_opt_in __RPC__in __exceptthat __maybenull
#define __RPC__deref_opt_in_string                                             \
  __RPC__deref_opt_in __pre __deref __nullterminated
...
#define __RPC__deref_opt_in_opt_string                                         \
  __RPC__deref_opt_in_opt __pre __deref __nullterminated
...
#define __RPC__inout_xcount_full_opt_string(size)                              \
  __RPC__inout_opt __pre __nullterminated __post __nullterminated
...
#define __RPC__deref_inout_xcount_full_string(size)                            \
  __RPC__deref_inout __post __deref __nullterminated
#define __RPC__deref_inout_xcount_full_opt_string(size)                        \
  __RPC__deref_inout_opt __pre __deref __nullterminated __post __deref         \
      __nullterminated
...
#define __RPC__deref_out_xcount_opt(size)                                      \
  __RPC__out __post __deref __exceptthat __maybenull __pre __deref __null
#define __RPC__deref_out_xcount_part_opt(size, length)                         \
  __RPC__deref_out __post __deref __exceptthat __maybenull __pre __deref __null
#define __RPC__deref_out_xcount_full_opt(size)                                 \
  __RPC__deref_out_opt __pre __deref __null
