...
// DEFINE_CLSID(AudioVolumeMeter, C0C56F46, 29B1, 44E9, 99, 39, A3, 2C, E8, 68,
// 67, E2); DEFINE_CLSID(AudioVolumeMeter_Debug, C0C56F46, 29B1, 44E9, 99, 39,
// A3, 2C, E8, 68, 67, DB); DEFINE_CLSID(AudioReverb, 6F6EA3A9, 2CF5, 41CF, 91,
// C1, 21, 70, B1, 54, 00, 63); DEFINE_CLSID(AudioReverb_Debug, 6F6EA3A9, 2CF5,
// 41CF, 91, C1, 21, 70, B1, 54, 00, DB);

// XAudio 2.1 (June 2008 SDK)
// DEFINE_CLSID(AudioVolumeMeter, c1e3f122, a2ea, 442c, 85, 4f, 20, d9, 8f, 83,
// 57, a1); DEFINE_CLSID(AudioVolumeMeter_Debug, 6d97a461, b02d, 48ae, b5, 43,
// 82, bc, 35, fd, fa, e2); DEFINE_CLSID(AudioReverb, f4769300, b949, 4df9, b3,
// 33, 00, d3, 39, 32, e9, a6); DEFINE_CLSID(AudioReverb_Debug, aea2cabc, 8c7c,
// 46aa, ba, 44, 0e, 6d, 75, 88, a1, f2);

// XAudio 2.2 (August 2008 SDK)
// DEFINE_CLSID(AudioVolumeMeter, f5ca7b34, 8055, 42c0, b8, 36, 21, 61, 29, eb,
// 7e, 30); DEFINE_CLSID(AudioVolumeMeter_Debug, f796f5f7, 6059, 4a9f, 98, 2d,
// 61, ee, c2, ed, 67, ca); DEFINE_CLSID(AudioReverb, 629cf0de, 3ecc, 41e7, 99,
// 26, f7, e4, 3e, eb, ec, 51); DEFINE_CLSID(AudioReverb_Debug, 4aae4299, 3260,
// 46d4, 97, cc, 6c, c7, 60, c8, 53, 29);

// XAudio 2.3 (November 2008 SDK)
// DEFINE_CLSID(AudioVolumeMeter, e180344b, ac83, 4483, 95, 9e, 18, a5, c5, 6a,
// 5e, 19); DEFINE_CLSID(AudioVolumeMeter_Debug, 922a0a56, 7d13, 40ae, a4, 81,
// 3c, 6c, 60, f1, 14, 01); DEFINE_CLSID(AudioReverb, 9cab402c, 1d37, 44b4, 88,
// 6d, fa, 4f, 36, 17, 0a, 4c); DEFINE_CLSID(AudioReverb_Debug, eadda998, 3be6,
// 4505, 84, be, ea, 06, 36, 5d, b9, 6b);

// XAudio 2.4 (March 2009 SDK)
// DEFINE_CLSID(AudioVolumeMeter, c7338b95, 52b8, 4542, aa, 79, 42, eb, 01, 6c,
// 8c, 1c); DEFINE_CLSID(AudioVolumeMeter_Debug, 524bd872, 5c0b, 4217, bd, b8,
// 0a, 86, 81, 83, 0b, a5); DEFINE_CLSID(AudioReverb, 8bb7778b, 645b, 4475, 9a,
// 73, 1d, e3, 17, 0b, d3, af); DEFINE_CLSID(AudioReverb_Debug, da7738a2, cd0c,
// 4367, 9a, ac, d7, ea, d7, c6, 4f, 98);

// XAudio 2.5 (March 2009 SDK)
// DEFINE_CLSID(AudioVolumeMeter, 2139e6da, c341, 4774, 9a, c3, b4, e0, 26, 34,
// 7f, 64); DEFINE_CLSID(AudioVolumeMeter_Debug, a5cc4e13, ca00, 416b, a6, ee,
// 49, fe, e7, b5, 43, d0); DEFINE_CLSID(AudioReverb, d06df0d0, 8518, 441e, 82,
// 2f, 54, 51, d5, c5, 95, b8); DEFINE_CLSID(AudioReverb_Debug, 613604ec, 304c,
// 45ec, a4, ed, 7a, 1c, 61, 2e, 9e, 72);

// XAudio 2.6 (February 2010 SDK)
// DEFINE_CLSID(AudioVolumeMeter, e48c5a3f, 93ef, 43bb, a0, 92, 2c, 7c, eb, 94,
// 6f, 27); DEFINE_CLSID(AudioVolumeMeter_Debug, 9a9eaef7, a9e0, 4088, 9b, 1b,
// 9c, a0, 3a, 1a, ec, d4); DEFINE_CLSID(AudioReverb, cecec95a, d894, 491a, be,
// e3, 5e, 10, 6f, b5, 9f, 2d); DEFINE_CLSID(AudioReverb_Debug, 99a1c72e, 364c,
// 4c1b, 96, 23, fd, 5c, 8a, bd, 90, c7);

// XAudio 2.7 (June 2010 SDK)
DEFINE_CLSID(AudioVolumeMeter, cac1105f, 619b, 4d04, 83, 1a, 44, e1, cb, f1, 2d,
             57);
DEFINE_CLSID(AudioVolumeMeter_Debug, 2d9a0f9c, e67b, 4b24, ab, 44, 92, b3, e7,
             70, c0, 20);
DEFINE_CLSID(AudioReverb, 6a93130e, 1d53, 41d1, a9, cf, e7, 58, 80, 0b, b1, 79);
DEFINE_CLSID(AudioReverb_Debug, c4f82dd4, cb4e, 4ce1, 8b, db, ee, 32, d4, 19,
             82, 69);
...
__inline HRESULT XAudio2CreateVolumeMeter(__deref_out IUnknown **ppApo,
                                          UINT32 /*Flags*/ DEFAULT(0)) {
  return CreateAudioVolumeMeter(ppApo);
}

__inline HRESULT XAudio2CreateReverb(__deref_out IUnknown **ppApo,
                                     UINT32 /*Flags*/ DEFAULT(0)) {
...
__inline HRESULT XAudio2CreateVolumeMeter(__deref_out IUnknown **ppApo,
  ...
  return CoCreateInstance(
      (Flags & XAUDIO2FX_DEBUG) ? __uuidof(AudioVolumeMeter_Debug)
                                : __uuidof(AudioVolumeMeter),
      NULL, CLSCTX_INPROC_SERVER, __uuidof(IUnknown), (void **)ppApo);
#else
  return CoCreateInstance(
      (Flags & XAUDIO2FX_DEBUG) ? &CLSID_AudioVolumeMeter_Debug
...
#ifdef __cplusplus
  return CoCreateInstance(
      (Flags & XAUDIO2FX_DEBUG) ? __uuidof(AudioReverb_Debug)
                                : __uuidof(AudioReverb),
      NULL, CLSCTX_INPROC_SERVER, __uuidof(IUnknown), (void **)ppApo);
#else
  return CoCreateInstance(
      (Flags & XAUDIO2FX_DEBUG) ? &CLSID_AudioReverb_Debug : &CLSID_AudioReverb,
      NULL, CLSCTX_INPROC_SERVER, &IID_IUnknown, (void **)ppApo);
#endif
}
...
typedef struct XAUDIO2FX_VOLUMEMETER_LEVELS {
  float *pPeakLevels;  // Peak levels table: receives maximum absolute level for
                       // each channel over a processing pass; may be NULL if
                       // pRMSLevls != NULL, otherwise must have at least
                       // ChannelCount elements.
  float *pRMSLevels;   // Root mean square levels table: receives RMS level for
                       // each channel over a processing pass; may be NULL if
                       // pPeakLevels != NULL, otherwise must have at least
                       // ChannelCount elements.
  UINT32 ChannelCount; // Number of channels being processed by the volume meter
                       // APO
...
// XAUDIO2FX_REVERB_I3DL2_PARAMETERS: Parameter set compliant with the I3DL2
// standard
...
// ReverbConvertI3DL2ToNative: Utility function to map from I3DL2 to native
// parameters

__inline void
ReverbConvertI3DL2ToNative(__in const XAUDIO2FX_REVERB_I3DL2_PARAMETERS *pI3DL2,
...
#define XAUDIO2FX_I3DL2_PRESET_DEFAULT                                         \
  {100,    -10000, 0,      0.0f,   1.00f,  0.50f,  -10000,                     \
   0.020f, -10000, 0.040f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_GENERIC                                         \
  {100,    -1000, -100,   0.0f,   1.49f,  0.83f,  -2602,                       \
   0.007f, 200,   0.011f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_PADDEDCELL                                      \
  {100,    -1000, -6000,  0.0f,   0.17f,  0.10f,  -1204,                       \
   0.001f, 207,   0.002f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_ROOM                                            \
  {100,    -1000, -454,   0.0f,   0.40f,  0.83f,  -1646,                       \
   0.002f, 53,    0.003f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_BATHROOM                                        \
  {100,    -1000, -1200,  0.0f,   1.49f, 0.54f,  -370,                         \
   0.007f, 1030,  0.011f, 100.0f, 60.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_LIVINGROOM                                      \
  {100,    -1000, -6000,  0.0f,   0.50f,  0.10f,  -1376,                       \
   0.003f, -1104, 0.004f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_STONEROOM                                       \
  {100,    -1000, -300,   0.0f,   2.31f,  0.64f,  -711,                        \
   0.012f, 83,    0.017f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_AUDITORIUM                                      \
  {100,    -1000, -476,   0.0f,   4.32f,  0.59f,  -789,                        \
   0.020f, -289,  0.030f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_CONCERTHALL                                     \
  {100,    -1000, -500,   0.0f,   3.92f,  0.70f,  -1230,                       \
   0.020f, -2,    0.029f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_CAVE                                            \
  {100,    -1000, 0,      0.0f,   2.91f,  1.30f,  -602,                        \
   0.015f, -302,  0.022f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_ARENA                                           \
  {100,    -1000, -698,   0.0f,   7.24f,  0.33f,  -1166,                       \
   0.020f, 16,    0.030f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_HANGAR                                          \
  {100,    -1000, -1000,  0.0f,   10.05f, 0.23f,  -602,                        \
   0.020f, 198,   0.030f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_CARPETEDHALLWAY                                 \
  {100,    -1000, -4000,  0.0f,   0.30f,  0.10f,  -1831,                       \
   0.002f, -1630, 0.030f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_HALLWAY                                         \
  {100,    -1000, -300,   0.0f,   1.49f,  0.59f,  -1219,                       \
   0.007f, 441,   0.011f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_STONECORRIDOR                                   \
  {100,    -1000, -237,   0.0f,   2.70f,  0.79f,  -1214,                       \
   0.013f, 395,   0.020f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_ALLEY                                           \
  {100,    -1000, -270,   0.0f,   1.49f,  0.86f,  -1204,                       \
   0.007f, -4,    0.011f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_FOREST                                          \
  {100,    -1000, -3300,  0.0f,  1.49f,  0.54f,  -2560,                        \
   0.162f, -613,  0.088f, 79.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_CITY                                            \
  {100,    -1000, -800,   0.0f,  1.49f,  0.67f,  -2273,                        \
   0.007f, -2217, 0.011f, 50.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_MOUNTAINS                                       \
  {100,    -1000, -2500,  0.0f,  1.49f,  0.21f,  -2780,                        \
   0.300f, -2014, 0.100f, 27.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_QUARRY                                          \
  {100,    -1000, -1000,  0.0f,   1.49f,  0.83f,  -10000,                      \
   0.061f, 500,   0.025f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_PLAIN                                           \
  {100,    -1000, -2000,  0.0f,  1.49f,  0.50f,  -2466,                        \
   0.179f, -2514, 0.100f, 21.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_PARKINGLOT                                      \
  {100,    -1000, 0,      0.0f,   1.65f,  1.50f,  -1363,                       \
   0.008f, -1153, 0.012f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_SEWERPIPE                                       \
  {100,    -1000, -1000,  0.0f,  2.81f, 0.14f,  429,                           \
   0.014f, 648,   0.021f, 80.0f, 60.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_UNDERWATER                                      \
  {100,    -1000, -4000,  0.0f,   1.49f,  0.10f,  -449,                        \
   0.007f, 1700,  0.011f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_SMALLROOM                                       \
  {100,    -1000, -600,   0.0f,   1.10f,  0.83f,  -400,                        \
   0.005f, 500,   0.010f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_MEDIUMROOM                                      \
  {100,    -1000, -600,   0.0f,   1.30f,  0.83f,  -1000,                       \
   0.010f, -200,  0.020f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_LARGEROOM                                       \
  {100,    -1000, -600,   0.0f,   1.50f,  0.83f,  -1600,                       \
   0.020f, -1000, 0.040f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_MEDIUMHALL                                      \
  {100,    -1000, -600,   0.0f,   1.80f,  0.70f,  -1300,                       \
   0.015f, -800,  0.030f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_LARGEHALL                                       \
  {100,    -1000, -600,   0.0f,   1.80f,  0.70f,  -2000,                       \
   0.030f, -1400, 0.060f, 100.0f, 100.0f, 5000.0f}
#define XAUDIO2FX_I3DL2_PRESET_PLATE                                           \
  {100,    -1000, -200,   0.0f,   1.30f, 0.90f,  0,                            \
   0.002f, 0,     0.010f, 100.0f, 75.0f, 5000.0f}
