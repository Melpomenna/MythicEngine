...
HRESULT WINAPI D3DX10CompileFromFileA(
    ...
    UINT Flags2, ID3DX10ThreadPump *pPump, ID3D10Blob **ppShader,
    ID3D10Blob **ppErrorMsgs, HRESULT *pHResult);

HRESULT WINAPI D3DX10CompileFromFileW(
...
HRESULT WINAPI D3DX10CompileFromResourceA(
...
HRESULT WINAPI D3DX10CompileFromResourceW(
...
HRESULT WINAPI D3DX10CompileFromMemory(
...
HRESULT WINAPI D3DX10CreateEffectFromFileA(
    ...
    ID3D10Include *pInclude, LPCSTR pProfile, UINT HLSLFlags, UINT FXFlags,
...
HRESULT WINAPI D3DX10CreateEffectFromMemory(
    ...
    LPCSTR pProfile, UINT HLSLFlags, UINT FXFlags, ID3D10Device *pDevice,
    ID3D10EffectPool *pEffectPool, ID3DX10ThreadPump *pPump,
    ID3D10Effect **ppEffect, ID3D10Blob **ppErrors, HRESULT *pHResult);
...
HRESULT WINAPI D3DX10CreateEffectPoolFromMemory(
    ...
    CONST D3D10_SHADER_MACRO *pDefines, ID3D10Include *pInclude,
    LPCSTR pProfile, UINT HLSLFlags, UINT FXFlags, ID3D10Device *pDevice,
    ID3DX10ThreadPump *pPump, ID3D10EffectPool **ppEffectPool,
    ID3D10Blob **ppErrors, HRESULT *pHResult);
...
HRESULT WINAPI D3DX10CreateAsyncCompilerProcessor(
    LPCSTR pFileName, CONST D3D10_SHADER_MACRO *pDefines,
    LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1,
...
HRESULT WINAPI D3DX10CreateAsyncEffectCreateProcessor(
    LPCSTR pFileName, CONST D3D10_SHADER_MACRO *pDefines,
    LPD3D10INCLUDE pInclude, LPCSTR pProfile, UINT Flags, UINT FXFlags,
    ID3D10Device *pDevice, ID3D10EffectPool *pPool, ID3D10Blob **ppErrorBuffer,
    ID3DX10DataProcessor **ppProcessor);

HRESULT WINAPI D3DX10CreateAsyncEffectPoolCreateProcessor(
    LPCSTR pFileName, CONST D3D10_SHADER_MACRO *pDefines,
    LPD3D10INCLUDE pInclude, LPCSTR pProfile, UINT Flags, UINT FXFlags,
    ID3D10Device *pDevice, ID3D10Blob **ppErrorBuffer,
    ID3DX10DataProcessor **ppProcessor);
