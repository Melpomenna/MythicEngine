...
typedef struct IGameExplorerVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGameExplorer *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGameExplorer *This);
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetCategoryTitle(
      /* [in] */ WORD categoryIndex,
      /* [retval][string][out] */ __RPC__deref_out_opt_string LPWSTR *
          pTitle) = 0;

  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetStatistic(
      /* [in] */ WORD categoryIndex,
      /* [in] */ WORD statIndex,
      /* [string][unique][out][in] */ __RPC__deref_opt_inout_opt_string LPWSTR *
          pName,
      /* [string][unique][out][in] */ __RPC__deref_opt_inout_opt_string LPWSTR *
          pValue) = 0;
...
typedef struct IGameStatisticsVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGameStatistics *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGameStatistics *This);
...
interface IGameStatistics { CONST_VTBL struct IGameStatisticsVtbl *lpVtbl; };
...
#define IGameStatistics_GetStatistic(This, categoryIndex, statIndex, pName,    \
                                     pValue)                                   \
  ((This)->lpVtbl->GetStatistic(This, categoryIndex, statIndex, pName, pValue))

#define IGameStatistics_SetStatistic(This, categoryIndex, statIndex, name,     \
                                     value)                                    \
...
typedef struct IGameStatisticsMgrVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGameStatisticsMgr *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGameStatisticsMgr *This);
...
#define IGameStatisticsMgr_GetGameStatistics(This, GDFBinaryPath, openType,    \
                                             pOpenResult, ppiStats)            \
  ((This)->lpVtbl->GetGameStatistics(This, GDFBinaryPath, openType,            \
                                     pOpenResult, ppiStats))
...
typedef struct IGameExplorer2Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(__RPC__in IGameExplorer2 *This);

  ULONG(STDMETHODCALLTYPE *Release)(__RPC__in IGameExplorer2 *This);
...
interface IGameExplorer2 { CONST_VTBL struct IGameExplorer2Vtbl *lpVtbl; };
...
#define IGameExplorer2_InstallGame(This, binaryGDFPath, installDirectory,      \
                                   installScope)                               \
  ((This)->lpVtbl->InstallGame(This, binaryGDFPath, installDirectory,          \
                               installScope))
...
unsigned long __RPC_USER BSTR_UserSize(__RPC__in unsigned long *, unsigned long,
                                       __RPC__in BSTR *);
unsigned char *__RPC_USER
BSTR_UserMarshal(__RPC__in unsigned long *,
                 __RPC__inout_xcount(0) unsigned char *, __RPC__in BSTR *);
unsigned char *__RPC_USER
BSTR_UserUnmarshal(__RPC__in unsigned long *,
                   __RPC__in_xcount(0) unsigned char *, __RPC__out BSTR *);
void __RPC_USER BSTR_UserFree(__RPC__in unsigned long *, __RPC__in BSTR *);

unsigned long __RPC_USER BSTR_UserSize64(__RPC__in unsigned long *,
                                         unsigned long, __RPC__in BSTR *);
unsigned char *__RPC_USER
BSTR_UserMarshal64(__RPC__in unsigned long *,
                   __RPC__inout_xcount(0) unsigned char *, __RPC__in BSTR *);
unsigned char *__RPC_USER
BSTR_UserUnmarshal64(__RPC__in unsigned long *,
                     __RPC__in_xcount(0) unsigned char *, __RPC__out BSTR *);
