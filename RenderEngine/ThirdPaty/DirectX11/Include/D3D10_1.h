...
typedef struct ID3D10BlendState1Vtbl {
  ...
  void(STDMETHODCALLTYPE *GetDesc)(ID3D10BlendState1 *This,
                                   /* [annotation] */
                                   __out D3D10_BLEND_DESC *pDesc);

  void(STDMETHODCALLTYPE *GetDesc1)(ID3D10BlendState1 *This,
                                    /* [annotation] */
...
typedef struct ID3D10ShaderResourceView1Vtbl {
  ...
  void(STDMETHODCALLTYPE *GetResource)(ID3D10ShaderResourceView1 *This,
                                       /* [annotation] */
...
typedef struct ID3D10Device1Vtbl {
  ...
  void(STDMETHODCALLTYPE *DrawIndexed)(ID3D10Device1 *This,
                                       /* [annotation] */
  ...
  void(STDMETHODCALLTYPE *Draw)(ID3D10Device1 *This,
                                /* [annotation] */
  ...
  void(STDMETHODCALLTYPE *IASetIndexBuffer)(ID3D10Device1 *This,
                                            /* [annotation] */
  ...
  void(STDMETHODCALLTYPE *DrawIndexedInstanced)(ID3D10Device1 *This,
                                                /* [annotation] */
  ...
  void(STDMETHODCALLTYPE *DrawInstanced)(ID3D10Device1 *This,
                                         /* [annotation] */
  ...
  void(STDMETHODCALLTYPE *GSSetShader)(ID3D10Device1 *This,
                                       /* [annotation] */
                                       __in_opt ID3D10GeometryShader *pShader);

  void(STDMETHODCALLTYPE *IASetPrimitiveTopology)(ID3D10Device1 *This,
                                                  /* [annotation] */
  ...
  void(STDMETHODCALLTYPE *SetPredication)(ID3D10Device1 *This,
                                          /* [annotation] */
  ...
  void(STDMETHODCALLTYPE *CopyResource)(ID3D10Device1 *This,
                                        /* [annotation] */
                                        __in ID3D10Resource *pDstResource,
                                        /* [annotation] */
                                        __in ID3D10Resource *pSrcResource);

  void(STDMETHODCALLTYPE *UpdateSubresource)(ID3D10Device1 *This,
                                             /* [annotation] */
                                             __in ID3D10Resource *pDstResource,
                                             /* [annotation] */
                                             __in UINT DstSubresource,
  ...
  void(STDMETHODCALLTYPE *ResolveSubresource)(ID3D10Device1 *This,
                                              /* [annotation] */
                                              __in ID3D10Resource *pDstResource,
                                              /* [annotation] */
                                              __in UINT DstSubresource,
  ...
  void(STDMETHODCALLTYPE *PSGetShader)(ID3D10Device1 *This,
                                       /* [annotation] */
  ...
  (ID3D10Device1 *This, UINT RaiseFlags);
  ...
  void(STDMETHODCALLTYPE *SetTextFilterSize)(ID3D10Device1 *This,
                                             /* [annotation] */
                                             __in UINT Width,
                                             /* [annotation] */
                                             __in UINT Height);

  void(STDMETHODCALLTYPE *GetTextFilterSize)(ID3D10Device1 *This,
                                             /* [annotation] */
...
interface ID3D10Device1 { CONST_VTBL struct ID3D10Device1Vtbl *lpVtbl; };
...
#define ID3D10Device1_VSSetConstantBuffers(This, StartSlot, NumBuffers,        \
                                           ppConstantBuffers)                  \
  ((This)->lpVtbl->VSSetConstantBuffers(This, StartSlot, NumBuffers,           \
                                        ppConstantBuffers))

#define ID3D10Device1_PSSetShaderResources(This, StartSlot, NumViews,          \
...
#define ID3D10Device1_DrawIndexed(This, IndexCount, StartIndexLocation,        \
                                  BaseVertexLocation)                          \
...
#define ID3D10Device1_PSSetConstantBuffers(This, StartSlot, NumBuffers,        \
                                           ppConstantBuffers)                  \
...
#define ID3D10Device1_IASetVertexBuffers(This, StartSlot, NumBuffers,          \
...
#define ID3D10Device1_DrawIndexedInstanced(                                    \
...
#define ID3D10Device1_DrawInstanced(This, VertexCountPerInstance,              \
                                    InstanceCount, StartVertexLocation,        \
                                    StartInstanceLocation)                     \
  ((This)->lpVtbl->DrawInstanced(This, VertexCountPerInstance, InstanceCount,  \
                                 StartVertexLocation, StartInstanceLocation))

#define ID3D10Device1_GSSetConstantBuffers(This, StartSlot, NumBuffers,        \
                                           ppConstantBuffers)                  \
...
#define ID3D10Device1_VSSetShaderResources(This, StartSlot, NumViews,          \
                                           ppShaderResourceViews)              \
...
#define ID3D10Device1_GSSetShaderResources(This, StartSlot, NumViews,          \
                                           ppShaderResourceViews)              \
...
#define ID3D10Device1_OMSetRenderTargets(This, NumViews, ppRenderTargetViews,  \
                                         pDepthStencilView)                    \
  ((This)->lpVtbl->OMSetRenderTargets(This, NumViews, ppRenderTargetViews,     \
                                      pDepthStencilView))

#define ID3D10Device1_OMSetBlendState(This, pBlendState, BlendFactor,          \
                                      SampleMask)                              \
  ((This)->lpVtbl->OMSetBlendState(This, pBlendState, BlendFactor, SampleMask))

#define ID3D10Device1_OMSetDepthStencilState(This, pDepthStencilState,         \
                                             StencilRef)                       \
...
#define ID3D10Device1_CopySubresourceRegion(                                   \
    This, pDstResource, DstSubresource, DstX, DstY, DstZ, pSrcResource,        \
...
#define ID3D10Device1_UpdateSubresource(This, pDstResource, DstSubresource,    \
...
#define ID3D10Device1_ClearDepthStencilView(This, pDepthStencilView,           \
...
#define ID3D10Device1_ResolveSubresource(This, pDstResource, DstSubresource,   \
                                         pSrcResource, SrcSubresource, Format) \
  ((This)->lpVtbl->ResolveSubresource(This, pDstResource, DstSubresource,      \
                                      pSrcResource, SrcSubresource, Format))

#define ID3D10Device1_VSGetConstantBuffers(This, StartSlot, NumBuffers,        \
                                           ppConstantBuffers)                  \
  ((This)->lpVtbl->VSGetConstantBuffers(This, StartSlot, NumBuffers,           \
                                        ppConstantBuffers))

#define ID3D10Device1_PSGetShaderResources(This, StartSlot, NumViews,          \
                                           ppShaderResourceViews)              \
...
#define ID3D10Device1_PSGetConstantBuffers(This, StartSlot, NumBuffers,        \
                                           ppConstantBuffers)                  \
...
#define ID3D10Device1_IAGetVertexBuffers(This, StartSlot, NumBuffers,          \
                                         ppVertexBuffers, pStrides, pOffsets)  \
...
#define ID3D10Device1_GSGetConstantBuffers(This, StartSlot, NumBuffers,        \
                                           ppConstantBuffers)                  \
...
#define ID3D10Device1_VSGetShaderResources(This, StartSlot, NumViews,          \
                                           ppShaderResourceViews)              \
...
#define ID3D10Device1_GSGetShaderResources(This, StartSlot, NumViews,          \
                                           ppShaderResourceViews)              \
...
#define ID3D10Device1_OMGetRenderTargets(This, NumViews, ppRenderTargetViews,  \
                                         ppDepthStencilView)                   \
  ((This)->lpVtbl->OMGetRenderTargets(This, NumViews, ppRenderTargetViews,     \
                                      ppDepthStencilView))

#define ID3D10Device1_OMGetBlendState(This, ppBlendState, BlendFactor,         \
                                      pSampleMask)                             \
  ((This)->lpVtbl->OMGetBlendState(This, ppBlendState, BlendFactor,            \
                                   pSampleMask))

#define ID3D10Device1_OMGetDepthStencilState(This, ppDepthStencilState,        \
                                             pStencilRef)                      \
...
#define ID3D10Device1_CreateShaderResourceView(This, pResource, pDesc,         \
                                               ppSRView)                       \
...
#define ID3D10Device1_CreateDepthStencilView(This, pResource, pDesc,           \
                                             ppDepthStencilView)               \
  ((This)->lpVtbl->CreateDepthStencilView(This, pResource, pDesc,              \
                                          ppDepthStencilView))

#define ID3D10Device1_CreateInputLayout(This, pInputElementDescs, NumElements, \
...
#define ID3D10Device1_CreatePixelShader(This, pShaderBytecode, BytecodeLength, \
                                        ppPixelShader)                         \
...
#define ID3D10Device1_CreateDepthStencilState(This, pDepthStencilDesc,         \
                                              ppDepthStencilState)             \
  ((This)->lpVtbl->CreateDepthStencilState(This, pDepthStencilDesc,            \
                                           ppDepthStencilState))

#define ID3D10Device1_CreateRasterizerState(This, pRasterizerDesc,             \
                                            ppRasterizerState)                 \
...
#define ID3D10Device1_CheckMultisampleQualityLevels(This, Format, SampleCount, \
                                                    pNumQualityLevels)         \
...
#define ID3D10Device1_CheckCounter(This, pDesc, pType, pActiveCounters,        \
...
#define ID3D10Device1_OpenSharedResource(This, hResource, ReturnedInterface,   \
                                         ppResource)                           \
...
#define ID3D10Device1_CreateShaderResourceView1(This, pResource, pDesc,        \
                                                ppSRView)                      \
...
//
///////////////////////////////////////////////////////////////////////////
typedef HRESULT(WINAPI *PFN_D3D10_CREATE_DEVICE_AND_SWAP_CHAIN1)(
...
DEFINE_GUID(IID_ID3D10BlendState1, 0xEDAD8D99, 0x8A35, 0x4d6d, 0x85, 0x66, 0x2E,
            0xA2, 0x76, 0xCD, 0xE1, 0x61);
DEFINE_GUID(IID_ID3D10ShaderResourceView1, 0x9B7E4C87, 0x342C, 0x4106, 0xA1,
            0x9F, 0x4F, 0x27, 0x04, 0xF6, 0x89, 0xF0);
DEFINE_GUID(IID_ID3D10Device1, 0x9B7E4C8F, 0x342C, 0x4106, 0xA1, 0x9F, 0x4F,
