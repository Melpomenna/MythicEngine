...
FLOAT *WINAPI D3DXSHRotate(__out_ecount(Order *Order) FLOAT *pOut, UINT Order,
                           CONST D3DXMATRIX *pMatrix, CONST FLOAT *pIn);
...
FLOAT *WINAPI D3DXSHAdd(__out_ecount(Order *Order) FLOAT *pOut, UINT Order,
...
FLOAT *WINAPI D3DXSHScale(__out_ecount(Order *Order) FLOAT *pOut, UINT Order,
                          CONST FLOAT *pIn, CONST FLOAT Scale);
...
__out_ecount(4) FLOAT *WINAPI
    D3DXSHMultiply2(__out_ecount(4) FLOAT *pOut, __in_ecount(4) CONST FLOAT *pF,
                    __in_ecount(4) CONST FLOAT *pG);
__out_ecount(9) FLOAT *WINAPI
    D3DXSHMultiply3(__out_ecount(9) FLOAT *pOut, __in_ecount(9) CONST FLOAT *pF,
...
HRESULT WINAPI D3DXSHEvalDirectionalLight(
    UINT Order, CONST D3DXVECTOR3 *pDir, FLOAT RIntensity, FLOAT GIntensity,
    FLOAT BIntensity, __out_ecount_opt(Order *Order) FLOAT *pROut,
...
HRESULT WINAPI
D3DXSHEvalSphericalLight(UINT Order, CONST D3DXVECTOR3 *pPos, FLOAT Radius,
