...
DEFINE_GUID(IID_ID3DX11ThreadPump, 0xc93fecfa, 0x6967, 0x478a, 0xab, 0xbc, 0x40,
...
DECLARE_INTERFACE_(ID3DX11ThreadPump, IUnknown) {
  ...
  (THIS_ ID3DX11DataLoader * pDataLoader, ID3DX11DataProcessor * pDataProcessor,
...
HRESULT WINAPI D3DX11CreateThreadPump(UINT cIoThreads, UINT cProcThreads,
