...
#define DIRECTSOUND_VERSION 0x0700 /* Version 7.0 */
       ...
       NTDDI_VERSION ==                                                        \
           NTDDI_WS03) /* Windows XP and SP1, or Windows Server 2003 */
#define DIRECTSOUND_VERSION 0x0800 /* Version 8.0 */
#else /* Windows XP SP2 and higher, Windows Server 2003 SP1 and higher,        \
         Longhorn, or higher */
...
extern HRESULT WINAPI DirectSoundCreate(__in_opt LPCGUID pcGuidDevice,
                                        __deref_out LPDIRECTSOUND *ppDS,
                                        __null LPUNKNOWN pUnkOuter);
extern HRESULT WINAPI DirectSoundEnumerateA(
    __in LPDSENUMCALLBACKA pDSEnumCallback, __in_opt LPVOID pContext);
extern HRESULT WINAPI DirectSoundEnumerateW(
    __in LPDSENUMCALLBACKW pDSEnumCallback, __in_opt LPVOID pContext);

extern HRESULT WINAPI DirectSoundCaptureCreate(
    __in_opt LPCGUID pcGuidDevice, __deref_out LPDIRECTSOUNDCAPTURE *ppDSC,
    __null LPUNKNOWN pUnkOuter);
...
#if DIRECTSOUND_VERSION >= 0x0800
extern HRESULT WINAPI DirectSoundCreate8(__in_opt LPCGUID pcGuidDevice,
                                         __deref_out LPDIRECTSOUND8 *ppDS8,
                                         __null LPUNKNOWN pUnkOuter);
extern HRESULT WINAPI DirectSoundCaptureCreate8(
    __in_opt LPCGUID pcGuidDevice, __deref_out LPDIRECTSOUNDCAPTURE8 *ppDSC8,
    __null LPUNKNOWN pUnkOuter);
extern HRESULT WINAPI DirectSoundFullDuplexCreate(
    __in_opt LPCGUID pcGuidCaptureDevice, __in_opt LPCGUID pcGuidRenderDevice,
    __in LPCDSCBUFFERDESC pcDSCBufferDesc, __in LPCDSBUFFERDESC pcDSBufferDesc,
    HWND hWnd, DWORD dwLevel, __deref_out LPDIRECTSOUNDFULLDUPLEX *ppDSFD,
    __deref_out LPDIRECTSOUNDCAPTUREBUFFER8 *ppDSCBuffer8,
    __deref_out LPDIRECTSOUNDBUFFER8 *ppDSBuffer8, __null LPUNKNOWN pUnkOuter);
#define DirectSoundFullDuplexCreate8 DirectSoundFullDuplexCreate

extern HRESULT WINAPI GetDeviceID(__in_opt LPCGUID pGuidSrc,
...
DECLARE_INTERFACE_(IReferenceClock, IUnknown) {
  ...
  (THIS_ REFERENCE_TIME rtBaseTime, REFERENCE_TIME rtStreamTime, HANDLE hEvent,
   __out LPDWORD pdwAdviseCookie) PURE;
...
DECLARE_INTERFACE_(IDirectSound, IUnknown) {
  ...
  (THIS_ __in LPCDSBUFFERDESC pcDSBufferDesc,
   __deref_out LPDIRECTSOUNDBUFFER * ppDSBuffer, __null LPUNKNOWN pUnkOuter)
      PURE;
  STDMETHOD(GetCaps)(THIS_ __out LPDSCAPS pDSCaps) PURE;
  STDMETHOD(DuplicateSoundBuffer)
  (THIS_ __in LPDIRECTSOUNDBUFFER pDSBufferOriginal,
...
DECLARE_INTERFACE_(IDirectSound8, IDirectSound) {
  ...
  STDMETHOD(CreateSoundBuffer)
  (THIS_ __in LPCDSBUFFERDESC pcDSBufferDesc,
   __out LPDIRECTSOUNDBUFFER * ppDSBuffer, __null LPUNKNOWN pUnkOuter) PURE;
  STDMETHOD(GetCaps)(THIS_ __out LPDSCAPS pDSCaps) PURE;
  STDMETHOD(DuplicateSoundBuffer)
  (THIS_ __in LPDIRECTSOUNDBUFFER pDSBufferOriginal,
...
DECLARE_INTERFACE_(IDirectSoundBuffer, IUnknown) {
  ...
  (THIS_ __out_opt LPDWORD pdwCurrentPlayCursor,
   __out_opt LPDWORD pdwCurrentWriteCursor) PURE;
  STDMETHOD(GetFormat)
  (THIS_ __out_bcount_opt(dwSizeAllocated) LPWAVEFORMATEX pwfxFormat,
   DWORD dwSizeAllocated, __out_opt LPDWORD pdwSizeWritten) PURE;
  ...
  (THIS_ __in LPDIRECTSOUND pDirectSound, __in LPCDSBUFFERDESC pcDSBufferDesc)
      PURE;
  STDMETHOD(Lock)
  (THIS_ DWORD dwOffset, DWORD dwBytes,
   __deref_out_bcount(*pdwAudioBytes1) LPVOID * ppvAudioPtr1,
   __out LPDWORD pdwAudioBytes1,
   __deref_opt_out_bcount(*pdwAudioBytes2) LPVOID * ppvAudioPtr2,
   __out_opt LPDWORD pdwAudioBytes2, DWORD dwFlags) PURE;
  STDMETHOD(Play)
  ...
  STDMETHOD(Unlock)
  (THIS_ __in_bcount(dwAudioBytes1) LPVOID pvAudioPtr1, DWORD dwAudioBytes1,
...
DECLARE_INTERFACE_(IDirectSoundBuffer8, IDirectSoundBuffer) {
  ...
  (THIS_ DWORD dwEffectsCount,
   __in_ecount_opt(dwEffectsCount) LPDSEFFECTDESC pDSFXDesc,
   __out_ecount_opt(dwEffectsCount) LPDWORD pdwResultCodes) PURE;
  STDMETHOD(AcquireResources)
  (THIS_ DWORD dwFlags, DWORD dwEffectsCount,
   __out_ecount(dwEffectsCount) LPDWORD pdwResultCodes) PURE;
  STDMETHOD(GetObjectInPath)
  (THIS_ __in REFGUID rguidObject, DWORD dwIndex, __in REFGUID rguidInterface,
   __deref_out LPVOID * ppObject) PURE;
};
...
DECLARE_INTERFACE_(IDirectSound3DListener, IUnknown) {
  ...
  (THIS_ __out D3DVECTOR * pvOrientFront, __out D3DVECTOR * pvOrientTop) PURE;
  ...
  (THIS_ __in LPCDS3DLISTENER pcListener, DWORD dwApply) PURE;
...
DECLARE_INTERFACE_(IDirectSound3DBuffer, IUnknown) {
  ...
  (THIS_ __out LPDWORD pdwInsideConeAngle, __out LPDWORD pdwOutsideConeAngle)
      PURE;
  ...
  STDMETHOD(GetVelocity)(THIS_ __out D3DVECTOR * pvVelocity) PURE;
  STDMETHOD(SetAllParameters)
  (THIS_ __in LPCDS3DBUFFER pcDs3dBuffer, DWORD dwApply) PURE;
...
DECLARE_INTERFACE_(IDirectSoundCapture, IUnknown) {
  ...
  (THIS_ __in LPCDSCBUFFERDESC pcDSCBufferDesc,
   __deref_out LPDIRECTSOUNDCAPTUREBUFFER * ppDSCBuffer,
   __null LPUNKNOWN pUnkOuter) PURE;
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer, IUnknown) {
  ...
  STDMETHOD(GetCurrentPosition)
  (THIS_ __out_opt LPDWORD pdwCapturePosition,
   __out_opt LPDWORD pdwReadPosition) PURE;
  STDMETHOD(GetFormat)
  (THIS_ __out_bcount_opt(dwSizeAllocated) LPWAVEFORMATEX pwfxFormat,
   DWORD dwSizeAllocated, __out_opt LPDWORD pdwSizeWritten) PURE;
  STDMETHOD(GetStatus)(THIS_ __out LPDWORD pdwStatus) PURE;
  STDMETHOD(Initialize)
  (THIS_ __in LPDIRECTSOUNDCAPTURE pDirectSoundCapture,
   __in LPCDSCBUFFERDESC pcDSCBufferDesc) PURE;
  STDMETHOD(Lock)
  (THIS_ DWORD dwOffset, DWORD dwBytes,
   __deref_out_bcount(*pdwAudioBytes1) LPVOID * ppvAudioPtr1,
   __out LPDWORD pdwAudioBytes1,
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer8, IDirectSoundCaptureBuffer) {
  ...
  (THIS_ __in REFGUID rguidObject, DWORD dwIndex, __in REFGUID rguidInterface,
   __deref_out LPVOID * ppObject) PURE;
  STDMETHOD(GetFXStatus)
  (DWORD dwEffectsCount, __out_ecount(dwEffectsCount) LPDWORD pdwFXStatus) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundNotify, IUnknown) {
  ...
  (THIS_ DWORD dwPositionNotifies,
   __in_ecount(dwPositionNotifies) LPCDSBPOSITIONNOTIFY pcPositionNotifies)
      PURE;
};
...
DECLARE_INTERFACE_(IKsPropertySet, IUnknown) {
  ...
  STDMETHOD(Get)
  (THIS_ __in REFGUID rguidPropSet, ULONG ulId,
   __in_bcount(ulInstanceLength) LPVOID pInstanceData, ULONG ulInstanceLength,
   __out_bcount(ulDataLength) LPVOID pPropertyData, ULONG ulDataLength,
   __out PULONG pulBytesReturned) PURE;
  STDMETHOD(Set)
  (THIS_ __in REFGUID rguidPropSet, ULONG ulId,
   __in_bcount(ulInstanceLength) LPVOID pInstanceData, ULONG ulInstanceLength,
   __in_bcount(ulDataLength) LPVOID pPropertyData, ULONG ulDataLength) PURE;
  STDMETHOD(QuerySupport)
  (THIS_ __in REFGUID rguidPropSet, ULONG ulId, __out PULONG pulTypeSupport)
      PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFXDistortion, IUnknown) {
  ...
  STDMETHOD(SetAllParameters)
  (THIS_ __in LPCDSFXDistortion pcDsFxDistortion) PURE;
  STDMETHOD(GetAllParameters)
  (THIS_ __out LPDSFXDistortion pDsFxDistortion) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFXCompressor, IUnknown) {
  ...
  STDMETHOD(SetAllParameters)
  (THIS_ __in LPCDSFXCompressor pcDsFxCompressor) PURE;
  STDMETHOD(GetAllParameters)
  (THIS_ __out LPDSFXCompressor pDsFxCompressor) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFXI3DL2Reverb, IUnknown) {
  ...
  STDMETHOD(SetAllParameters)
  (THIS_ __in LPCDSFXI3DL2Reverb pcDsFxI3DL2Reverb) PURE;
  STDMETHOD(GetAllParameters)
  (THIS_ __out LPDSFXI3DL2Reverb pDsFxI3DL2Reverb) PURE;
...
DECLARE_INTERFACE_(IDirectSoundFXWavesReverb, IUnknown) {
  ...
  STDMETHOD(SetAllParameters)
  (THIS_ __in LPCDSFXWavesReverb pcDsFxWavesReverb) PURE;
  STDMETHOD(GetAllParameters)
  (THIS_ __out LPDSFXWavesReverb pDsFxWavesReverb) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundCaptureFXNoiseSuppress, IUnknown) {
  ...
  STDMETHOD(SetAllParameters)
  (THIS_ __in LPCDSCFXNoiseSuppress pcDscFxNoiseSuppress) PURE;
  STDMETHOD(GetAllParameters)
  (THIS_ __out LPDSCFXNoiseSuppress pDscFxNoiseSuppress) PURE;
  STDMETHOD(Reset)(THIS) PURE;
};
...
DECLARE_INTERFACE_(IDirectSoundFullDuplex, IUnknown) {
  ...
  STDMETHOD(Initialize)
  (THIS_ __in LPCGUID pCaptureGuid, __in LPCGUID pRenderGuid,
   __in LPCDSCBUFFERDESC lpDscBufferDesc, __in LPCDSBUFFERDESC lpDsBufferDesc,
   HWND hWnd, DWORD dwLevel,
   __deref_out LPLPDIRECTSOUNDCAPTUREBUFFER8 lplpDirectSoundCaptureBuffer8,
   __deref_out LPLPDIRECTSOUNDBUFFER8 lplpDirectSoundBuffer8) PURE;
};
